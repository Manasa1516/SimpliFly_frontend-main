  ...
  return (
      ...
      <div className="register-page">
        <div className="register-div">
          ...
          <img src={Registeruserimg} className="register-image"/>
            ...
            <span style={{ color: 'red',fontSize:'15px',marginBottom:"30px" }}>{formError}</span>
    ...
    <div className="radio-buttons">
        ...
        <input type="radio" id="other" name="gender" value="other" checked={gender === "other"} onChange={(e) => setGender(e.target.value)} />
            ...
            <span style={{ color: 'red',fontSize:'15px',marginTop:'-30px' }}>{registerformError}</span>
        </div>
